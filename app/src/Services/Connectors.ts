...
export const offlineConnectors = Object.values(Blockchains).reduce(
...
export const BlockchainChainId = Object.values(Blockchains).reduce(
  (obj: { [B in Blockchains]?: number }, b: string) => {
    const blockchain = b as Blockchains
